 ...
 * - Issues an HttpOnly access_token cookie and a readable csrf_token.
 */
 ...
 * GET /auth/state
 * - Always returns 200.
 * - Indicates whether the request is authenticated (by cookie or header token).
 */
...
/**
 * POST /auth/logout
 * - Clears all variations of access_token and csrf_token cookies.
 * - Ensures both domain and non-domain variants are removed.
 */
router.post('/logout', (req, res) => {
  ...
  // Clear csrf_token cookies (readable)
